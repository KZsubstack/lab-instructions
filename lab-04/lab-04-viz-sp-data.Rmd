...
- State with fewest locations: Maine

**Is this surprising? Why or why not?**

This is not very surprising. California having the most Denny's makes sense since it is the most populated state in the country. Texas having the most La Quinta locations also makes sense since La Quinta was actually founded in San Antonio so the chain naturally expanded there first. Delaware and Maine having the fewest locations for each is not surprising either since both are small states with smaller populations and less highway traffic compared to the rest of the country.
---
...
the joke partially holds in North Carolina. Around the central part of the state where longitude is -81 to -80 and -79 to -78 you can see teal and pink points clustering closely together. However there are many Denny's locations in the southern and western parts of the state with no La Quinta nearby at all, so the joke doesn't hold perfectly across the whole state.
...
Yes, way more than in North Carolina. The pink and teal points are heavily overlapping and clustered together, especially around Dallas and Houston.


**Compare North Carolina and Texas: In which state does the joke seem more accurate?**

The joke holds better in Texas. In North Carolina there were a lot of Denny's with no La Quinta anywhere close by. In Texas the two establishments are consistently next to each other across the whole state, which makes sense since La Quinta was founded in San Antonio so that's where the highest concentration of both locations are.
