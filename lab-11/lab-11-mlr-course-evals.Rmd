...
$$\widehat{score} = 3.8803 + 0.0666 \times bty\_avg$$

**R² value:** 0.0350

**Adjusted R² value:** 0.0328
...
$$\widehat{score} = 3.7473 + 0.0742 \times bty\_avg + 0.1724 \times gendermale$$

**R² value:** 0.0591

**Adjusted R² value:** 0.0549
...
The intercept represents the expected evaluation score for female professors with a beauty rating of 0. That expected score is 3.7473.

**Interpret the slope for bty_avg:**

Holding gender constant, for every one unit increase in beauty rating, the expected evaluation score increases by 0.0742 points on average.

**Interpret the slope for gendermale:**

Holding beauty rating constant, male professors are expected to score 0.1724 points higher than female professors on average.
...
$$\widehat{score} = 3.9197 + 0.0742 \times bty\_avg$$
...
**The coefficient is:** 0.1724 (positive)

**Therefore:** Male professors tend to have higher course evaluation scores than female professors with the same beauty rating.

**By how much?** 0.1724 points higher on average.
...
The relationship between beauty and evaluation score does not vary between male and female professors because the model uses a single shared slope for bty_avg. Both groups have the same slope of 0.0742; the lines are parallel, only shifted by the gendermale coefficient.
...
**score_bty_fit adjusted R²:** 0.0328 (from Exercise 2)

**score_bty_gen_fit adjusted R²:** 0.0549 (from Exercise 3)

**Difference:** 0.0221

**Interpretation:**

The adjusted R² increased by 0.0221 when we added gender to the model. This tells us that gender explains additional variability in professor evaluation scores beyond what beauty rating alone captures, and that the improvement is not simply due to adding another predictor.
...
The slope has changed. The difference is 0.0076. Adding gender shifted the bty_avg slope slightly upward, which is consistent with beauty and gender being correlated in this dataset. Controlling for gender adjusts the estimated effect of beauty on score.
...
$$\widehat{score} = 3.9815 + 0.0677 \times bty\_avg + (-0.1607) \times ranktenuretrack + (-0.1261) \times ranktenured$$

**Interpret the intercept:**

For teaching faculty with a beauty rating of 0, the expected evaluation score is 3.9815.

**Interpret the slope for bty_avg:**

Holding rank constant, for every one unit increase in beauty rating, the expected evaluation score increases by 0.0677 points on average.

**Interpret the slope for ranktenuretrack:**

Holding beauty rating constant, tenure track faculty are expected to score 0.1607 points lower than teaching faculty on average.

**Interpret the slope for ranktenured:**

Holding beauty rating constant, tenured faculty are expected to score 0.1261 points lower than teaching faculty on average.

**Adjusted R² for this model:** 0.0413

**How does this compare to score_bty_gen_fit?**

The adjusted R² for score_bty_rank_fit (0.0413) is lower than for score_bty_gen_fit (0.0549). Gender explains more of the variability in evaluation scores than rank does, when each is paired with beauty rating.
